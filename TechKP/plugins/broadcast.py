...
@Client.on_message(filters.command("broadcast") & filters.user(Config.SUDO_USERS))  # type: ignore
...
@Client.on_callback_query(filters.regex(r'^broadcast_cancel') & filters.user(Config.SUDO_USERS))  # type: ignore
